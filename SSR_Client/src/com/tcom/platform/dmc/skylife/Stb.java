...
//		}
	...
	public String getSubscribeID() {
	    //2018-08-03, daegon.kim, 스카이라이프 전용
		if(subscribeID == null) {
		    try {
                subscribeID = com.kt.sso.SSOClient.getInstance().getSAID();
            } catch(Exception e) {
		        LOG.print("KT SSO Client is not found...");
		        //2018-11-14, SAID를 못가져오는 현상... SmartCard ID로 일단 등록처리
		        subscribeID=getSmartcardID();
            }
	...
	public String getSmartcardID() {
        //2018-08-03, daegon.kim, 스카이라이프 전용
		if(scId == null){
            STBInformation stb = new STBInformation();
            scId=String.valueOf(stb.getCardId());
        }
		return scId;
	}
