...
import com.tcom.platform.dmc.skylife.UserKeyManager;
...
public class Keymap implements KeymapInterface {
    ...
    public Keymap() {
        LOG.print("Load Skylife Keymap");
        keyListener = new KeyListenerImpl();
        UserKeyManager.getInstance();
        //UserKeyManager.getInstance().reservePrevKey();
	...
	public void setEnableNumKey(boolean enable) {
		if(enable) {
		    eventGroup.addAllNumericKeys();
			UserKeyManager.getInstance().reserveNumericKeys();
		} else {
		    eventGroup.removeAllNumericKeys();
			UserKeyManager.getInstance().releaseNumericKeys();
		}
	...
	public void setEnableBackKey(boolean enable) {
		if(enable) {
		    ...
		    UserKeyManager.getInstance().releasePrevKey();
